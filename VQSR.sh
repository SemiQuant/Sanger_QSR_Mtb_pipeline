...
#sh "/Users/jdlim/Desktop/full pipline/New ref genome/Variant Scripts/VQSR - working but need to edit for pipeline.txt" "$Ref_name" "$InVcf" "$Seq_stats" "$Name" "$Script_dir/references/Variants/Broad Variants - Partic mapped/SA.1_merged_PASS.vcf" "$Script_dir/references/Variants/Broad Variants - Partic mapped/india_ALL_merged_PASS.vcf" "$Script_dir/references/Variants/Broad Variants - Partic mapped/india_ALL_merged.vcf" "$Script_dir/references/Variants/Broad Variants - Partic mapped/SA.1_merged.vcf"
